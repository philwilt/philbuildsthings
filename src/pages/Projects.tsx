    ...
    <div className="bg-gray-900 min-h-screen py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <h1 className="text-5xl font-bold text-white mb-4">Builds</h1>
        ...
        <section>
          <h2 className="text-3xl font-bold text-white mb-6">More Build Tracks</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link
              to="/systems"
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
              ...
              <p className="text-gray-400">Laser cutting and fabrication projects.</p>
            </div>
          </div>
        </section>
      </div>
